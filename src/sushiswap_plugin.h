...
// Name of the plugin.
#define PLUGIN_NAME "Sushiswap"

// Number of selectors defined in this plugin.
#define NUM_SUSHISWAP_SELECTORS 8
...
extern const uint8_t *const SUSHISWAP_SELECTORS[NUM_SUSHISWAP_SELECTORS];
...
typedef struct sushiswap_parameters_t {
...
} sushiswap_parameters_t;

// Piece of code that will check that the above structure is not bigger than 5 * 32. Do not remove
// this check.
// TODO: unify this with the check in ethPluginInitContract.
_Static_assert(sizeof(sushiswap_parameters_t) <= 5 * 32, "Structure of parameters too big.");
